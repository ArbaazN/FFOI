...
<body>
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border:1px solid grey;">
        ...
        <h2 style="color: #7bba27; margin-top: 30px;">New Contact Form Submission</h2>
        ...
        <h3 style="color: #0b1d2e; margin-top: 0;">Contact Information</h3>
            ...
            @if(!empty($contact->city))<p><strong>Location:</strong> {{ $contact->city }}, {{ $contact->state }}</p>@endif
        </div>
        ...
        <p style="color: #64748B; font-size: 12px;">
            This email was sent from the FFOI Contact Form.
        </p>
        </div>
    </div>
</body>
